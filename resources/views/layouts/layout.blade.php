...
<head>
		...
		<meta name="description" content="management application" />
		...
		<link href="{{asset('../theme/html/demo1/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle49d8.css?v=7.2.8')}}" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="#" target="_blank" class="text-dark-75 text-hover-primary">MasterSoft</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
		...
		<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
				<h3 class="font-weight-bold m-0">Informations
				</h3>
		...
		<script src="{{asset('../theme/html/demo1/dist/assets/js/pages/crud/forms/widgets/select249d8.js?v=7.2.8')}}"></script>
		<script src="{{asset('../theme/html/demo1/dist/assets/js/pages/crud/forms/widgets/bootstrap-datepicker49d8.js?v=7.2.8')}}"></script>
		<!--end::Global Theme Bundle-->
		<!--begin::Page Vendors(used by this page)-->
		<script src="{{asset('../theme/html/demo1/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle49d8.js?v=7.2.8')}}"></script>
		<!--end::Page Vendors-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="{{asset('../theme/html/demo1/dist/assets/js/pages/widgets49d8.js?v=7.2.8')}}"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
